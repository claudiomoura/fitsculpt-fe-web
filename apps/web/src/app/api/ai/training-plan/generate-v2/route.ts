...
const ENDPOINT = "/ai/training-plan/generate-v2";
...
function logAiGenerateError(details: {
  ...
  console.warn("[bff.ai.training.generate-v2.error]", {
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const response = await fetch(`${getBackendUrl()}/ai/training-plan/generate-v2`, {
      method: "POST",
      headers: {
