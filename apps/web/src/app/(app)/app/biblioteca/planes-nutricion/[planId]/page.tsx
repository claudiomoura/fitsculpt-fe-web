...
export default async function NutritionPlanDetailPage(props: { params: Promise<{ planId: string }> }) {
    ...
    return (
      <div className="page">
        <section className="card" style={{ maxWidth: 960, margin: "0 auto" }}>
          ...
          <Link className="btn" style={{ width: "fit-content", marginTop: 12 }} href="/app/biblioteca/planes-nutricion">
    ...
    <div className="page">
      <section className="card" style={{ maxWidth: 960, margin: "0 auto" }}>
        <div className="form-stack">
          <Link className="muted" href="/app/biblioteca/planes-nutricion">
            {t("dietPlanDetail.backToPlans")}
          </Link>
