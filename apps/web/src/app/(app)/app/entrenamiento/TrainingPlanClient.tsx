...
<div className="section-head section-head-actions">
  ...
  <div className="section-actions">
    ...
    <button type="button" className="btn" disabled={!form || aiLoading} onClick={handleGenerateClick}>
            ...
            <section className="card">
              <div className="empty-state">
                ...
                <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                  <button type="button" className="btn" disabled={aiLoading} onClick={handleGenerateClick}>
                    {aiLoading ? t("training.aiGenerating") : t("training.aiGenerate")}
                  </button>
                  <Link href="/app/entrenamiento/editar" className="btn secondary">
