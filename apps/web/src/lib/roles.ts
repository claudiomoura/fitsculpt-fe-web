...
const TRAINER_ROLE_TOKENS = ["TRAINER", "COACH", "ROLE_TRAINER", "ROLE_COACH", "MANAGER", "ROLE_MANAGER"];
...
const TRAINER_PERMISSION_TOKENS = ["TRAINER", "ROLE_TRAINER", "TRAINER_READ", "MANAGER", "ROLE_MANAGER"];
