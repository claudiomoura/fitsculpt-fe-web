...
export function FeatureCard({ title, description, iconSrc, className, ...props }: FeatureCardProps) {
  return (
    <Card className={cn("landing-feature-card", className)} {...props}>
      <Image src={iconSrc} alt={title} className="landing-feature-card__icon" width={40} height={40} />
