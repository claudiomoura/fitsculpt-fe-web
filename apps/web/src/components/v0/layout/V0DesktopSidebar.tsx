...
export function V0DesktopSidebar({ items, brand = "Fit Sculpt" }: V0DesktopSidebarProps) {
  return (
    <aside className="hidden h-full w-full max-w-[260px] flex-col rounded-3xl border border-white/10 bg-slate-950/70 p-4 shadow-xl backdrop-blur md:flex">
      <div className="mb-6 px-2">
        <p className="text-xs font-medium uppercase tracking-[0.2em] text-cyan-300/80">{brand}</p>
      </div>
